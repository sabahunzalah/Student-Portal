...
import brandLogo from "assets/images/smit-stud.png"; // Import your logo
    ...
    <CacheProvider value={rtlCache}>
      <ThemeProvider theme={darkMode ? themeDarkRTL : themeRTL}>
        ...
        {layout === "dashboard" && pathname !== "/authentication/RegisterForm/register" && (
          <>
            <Sidenav
              color="green" // Customize the color of the sidebar here
              brand={brandLogo} // Use the imported logo image
